...
class BoundedModule(nn.Module):
    ...
    def compute_bounds(
            ...
            populate_trace=False, multi_net_target_coefs=None, multi_net_target_biases=None):
        ...
        if method == 'ibp':
            ...
            if bound_lower:
                ret1 = self.get_optimized_bounds(
                    ...
                    multi_net_target_coefs=multi_net_target_coefs, multi_net_target_biases=multi_net_target_biases)
            if bound_upper:
    ...
    from .optimized_bounds import (
        get_optimized_bounds, init_slope, get_cross_execution_params, get_multinet_params,
        extract_mininum_coef, get_cross_execution_loss, get_cross_network_loss,
